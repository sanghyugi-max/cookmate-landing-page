...
window.COOKMATE_CONFIG = {
  ...
  faq: { eyebrow: "07 / FAQ", title: "도입 전에 자주 묻는 질문", items: [ { question: "어떤 메뉴에 사용할 수 있나요?", answer: "사용 가능한 재료와 메뉴는 모델에 따라 달라집니다. 실제 메뉴와 투입량을 기준으로 조리 가능 여부를 확인해 주세요.", placeholder: false }, { question: "설치에 필요한 공간과 설비는 무엇인가요?", answer: "[등록 필요] 제품 크기, 이격거리, 전원·가스 및 배기 조건을 확인해 안내를 입력하세요.", placeholder: true }, { question: "세척과 유지관리는 어떻게 하나요?", answer: "[등록 필요] 공식 매뉴얼에 따른 분리 세척 범위, 세척 방법과 관리 주기를 입력하세요.", placeholder: true }, { question: "가격, 배송 및 A/S 조건은 어떻게 되나요?", answer: "[등록 필요] 실제 견적 방식, 배송·설치 비용, 보증기간 및 A/S 절차를 입력하세요.", placeholder: true } ] },
